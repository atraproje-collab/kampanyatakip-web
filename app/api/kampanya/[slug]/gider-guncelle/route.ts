/**
 * Server-side proxy: /api/kampanya/[slug]/gider-guncelle → n8n webhook
...
export async function POST(
  ...
  const targetUrl = `${N8N_BASE}/${encodeURIComponent(slug)}/gider-guncelle`;
  ...
  try {
    ...
    console.error(`[proxy] gider-guncelle POST failed for ${slug}:`, e);
    return Response.json(
      {
