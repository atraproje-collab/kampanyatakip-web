/**
 * Server-side proxy: /api/kampanya/[slug]/kumbara-guncelle → n8n webhook
 *
 * Forwards POST body to:
 *   https://n8n.srv1587680.hstgr.cloud/webhook/kampanya/{slug}/kumbara-guncelle
 *
...
export async function POST(
  ...
  const targetUrl = `${N8N_BASE}/${encodeURIComponent(slug)}/kumbara-guncelle`;
  ...
  try {
    ...
    console.error(`[proxy] kumbara-guncelle POST failed for ${slug}:`, e);
    return Response.json(
      {
