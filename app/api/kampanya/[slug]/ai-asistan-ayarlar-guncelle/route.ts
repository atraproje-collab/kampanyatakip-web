/**
 * Proxy: /api/kampanya/[slug]/ai-asistan-ayarlar-guncelle → n8n (POST)
 */
...
export async function POST(request: Request, { params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    const r = await fetch(`${N8N_BASE}/${encodeURIComponent(slug)}/ai-asistan-ayarlar-guncelle`, {
    ...
    console.error(`[proxy:ai-asistan-ayarlar-guncelle] ${slug}:`, e);
