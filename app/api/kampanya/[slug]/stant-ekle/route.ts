/**
 * Server-side proxy: /api/kampanya/[slug]/stant-ekle → n8n webhook
 *
 * Forwards POST body to:
 *   https://n8n.srv1587680.hstgr.cloud/webhook/kampanya/{slug}/stant-ekle
 *
...
export async function POST(
  ...
  const targetUrl = `${N8N_BASE}/${encodeURIComponent(slug)}/stant-ekle`;
  ...
  try {
    ...
    console.error(`[proxy] stant-ekle POST failed for ${slug}:`, e);
    return Response.json(
      {
