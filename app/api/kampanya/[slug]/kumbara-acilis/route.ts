/**
 * Server-side proxy: /api/kampanya/[slug]/kumbara-acilis → n8n webhook
 *
 * Forwards POST body to:
 *   https://n8n.srv1587680.hstgr.cloud/webhook/kampanya/{slug}/kumbara-acilis
 *
...
export async function POST(
  ...
  const targetUrl = `${N8N_BASE}/${encodeURIComponent(slug)}/kumbara-acilis`;
  ...
  try {
    ...
    console.error(`[proxy] kumbara-acilis POST failed for ${slug}:`, e);
    return Response.json(
      {
