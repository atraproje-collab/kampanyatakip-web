/**
 * Proxy: /api/kampanya/[slug]/ai-sablon-ekle → n8n (POST)
 */
...
export async function POST(request: Request, { params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    const r = await fetch(`${N8N_BASE}/${encodeURIComponent(slug)}/ai-sablon-ekle`, {
    ...
    console.error(`[proxy:ai-sablon-ekle] ${slug}:`, e);
