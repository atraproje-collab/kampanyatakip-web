/**
 * Proxy: /api/kampanya/[slug]/ai-asistan-ayarlar → n8n
 */
...
export async function GET(_req: Request, { params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    const r = await fetch(`${N8N_BASE}/${encodeURIComponent(slug)}/ai-asistan-ayarlar`, { cache: "no-store", headers: { Accept: "application/json" } });
    ...
    console.error(`[proxy:ai-asistan-ayarlar] ${slug}:`, e);
