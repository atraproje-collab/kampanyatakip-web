/**
 * Server-side proxy: /api/kampanya/[slug]/galeri-sil
 *  POST → n8n /webhook/kampanya/[slug]/galeri-sil
 */
...
export async function POST(
  ...
  const targetUrl = `${N8N_BASE}/${encodeURIComponent(slug)}/galeri-sil`;
  ...
  try {
    ...
    console.error(`[proxy] galeri-sil POST failed for ${slug}:`, e);
    return Response.json(
      {
