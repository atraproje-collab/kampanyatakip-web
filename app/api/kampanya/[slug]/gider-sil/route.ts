/**
 * Server-side proxy: /api/kampanya/[slug]/gider-sil → n8n webhook
 * Body: { id: "G-XX" } veya { gider_id: "..." }
...
export async function POST(
  ...
  const targetUrl = `${N8N_BASE}/${encodeURIComponent(slug)}/gider-sil`;
  ...
  try {
    ...
    console.error(`[proxy] gider-sil POST failed for ${slug}:`, e);
    return Response.json(
      {
