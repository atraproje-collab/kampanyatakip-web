/**
 * Server-side proxy: /api/kampanya/[slug]/gider-ekle → n8n webhook
...
export async function POST(
  ...
  const targetUrl = `${N8N_BASE}/${encodeURIComponent(slug)}/gider-ekle`;
  ...
  try {
    ...
    console.error(`[proxy] gider-ekle POST failed for ${slug}:`, e);
    return Response.json(
      {
