              ...
              {related.map((rel) => {
                ...
                return (
                  <Link
                    ...
                    className="group flex flex-col h-full rounded-2xl bg-white border border-outline-variant hover:border-secondary hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(0,24,53,0.08)] transition-all duration-250 p-5"
                  >
                    <div className="w-11 h-11 rounded-lg bg-secondary/10 text-secondary flex items-center justify-center mb-3 group-hover:bg-secondary group-hover:text-on-secondary transition-colors">
                      <RelIcon size={19} strokeWidth={1.9} />
                    </div>
                    <h3 className="text-[14.5px] font-semibold text-primary-container tracking-[-0.01em] mb-1.5 leading-tight">
                      {rel.title}
                    </h3>
